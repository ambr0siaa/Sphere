...
LADEF V2f v2f_norm(V2f v)
{
    return v2f_div(v, v2ff(v2f_len(v)));
}
...
LADEF V2d v2d_norm(V2d v)
{
    return v2d_div(v, v2dd(v2d_len(v)));
}
...
LADEF V3f v3f_norm(V3f v)
{
    return v3f_div(v, v3ff(v3f_len(v)));
}
...
LADEF V4f v4f_norm(V4f v)
{
    return v4f_div(v, v4ff(v4f_len(v)));
}
...
LADEF V4d v4d_norm(V4d v)
{
    return v4d_div(v, v4dd(v4d_len(v)));
}
